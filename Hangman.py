...
def play_hangman():
   ...
   words_to_guess = [
       'january', 'sky', 'image', 'film', 'promise', 'kids', 'ocean', 'oxygen', 'vodka', 'whiskey',
       'lungs', 'computer', 'rhyme', 'bug', 'plants', 'hero', 'world', 'money', 'lizard', 'python',
       'game', 'rugby', 'enjoy', 'dance', 'train'
   ]
   play = True
   while play:
